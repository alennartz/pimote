...
- `mobile/android/app/src/test/kotlin/com/pimote/android/**` — 97 unit tests against the test seams (`BackoffTest`, `ProtocolJsonTest`, `PhoneAccountRulesTest`, `ContactsSyncTest`, `SessionReducerTest`, `WsClientTest`, `SessionRepositoryImplTest`, `CallControllerTest` + colocated fakes); run via `make android-test`

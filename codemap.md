...
- `client/src/lib/components/TextBlock.svelte` — markdown text block with debounced rendering (150ms interval) during streaming and pre-rendered tail for unstyled deltas between renders
